...
class RentalModel extends Model
{
    ...
    public function addRental(Rental $rental)
    {
        ...
        $req = $this->getDb()->prepare('INSERT INTO `id_user`, `title`, `capacity`, `surface_area`, `content`, `cover` `city`, `address`, `content`, `country`, `price`, `latitude`, `longitude`) VALUES ( :id_user, :title, :capacity, :surface_area, :city, :address, :content, :cover, :country, :price, :latitude, :longitude )');
    ...
    public function getAllRentals()
    {
        ...
        $req = $this->getDb()->query('SELECT `id_rental`, `id_user`, `title`, `capacity`, `surface_area`, `content`, `cover`,  `city`, `address`, `country`, `price`, `latitude`, `longitude` FROM rental ORDER BY id_rental DESC');
    ...
    public function updateRental(Rental $rental)
    {
        ...
        $req = $this->getDb()->prepare('UPDATE `rental` SET `title` = :title, `capacity` = :capacity, `surface_area` = :surface_area, `city` = :city, `address` = :address,`content` = :content, `country` = :country, `price` = :price WHERE `id_rental` = :id, `latitude` = :latitude, `longitude` = :longitude');
